...
def get_model_instance(num_classes):
    return torchvision.models.detection.ssdlite320_mobilenet_v3_large(weights=None, pretrained=False,
...
def main():
    ...
    transfer_model = get_model_instance(num_classes)
    ...
    with open("SSD_losses.JSON", "wb") as fp:
    ...
    # Save the model!
    torch.save(transfer_model, f'../out/SSD.pt')
